...
- GET - http://localhost:8080/jpa/users/in28minutes/todos/10001
...
- PUT Request to http://localhost:8080/jpa/users/in28minutes/todos/10001 with BODY of Request given below
...
- name: rest-api-full-stack
  ...
  timeout: 120
  routes:
  - route: rest-api-full-stack-ranga-101.cfapps.io
  buildpacks:
...
- name: todo-app-react-frontend
  ...
  timeout: 120
  routes:
  - route: todo-app-react-frontend-ranga-101.cfapps.io
  buildpacks:
